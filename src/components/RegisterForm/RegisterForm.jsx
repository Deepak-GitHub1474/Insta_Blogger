...
const SignupForm = () => {
    ...
    return (
        <form action={formAction} className="flex flex-col gap-4 md:w-[60vw] w-[95vw] bg-gray-700 pb-16 pt-4 px-2 rounded-lg shadow-[0_5px_5px_white] relative overflow-hidden">
