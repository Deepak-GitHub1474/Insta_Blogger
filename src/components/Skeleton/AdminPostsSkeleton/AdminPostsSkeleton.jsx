...
const AdminPostsSkeleton = async () => {
  ...
  return(
    <div className="bg-gray-900 flex items-center justify-center gap-10 overflow-x-auto max-w-full p-2 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
