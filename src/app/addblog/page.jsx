import { addBlog } from "@/components/lib/action";

const AddBlogPage = () => {
    return (
        <div className="min-h-[80vh] bg-gray-900 text-white flex flex-col items-center justify-center">
            <form action={addBlog} className="flex flex-col gap-2 md:w-[60vw] w-[95vw] bg-gray-700 pb-16 pt-8 px-2 rounded-lg shadow-[0_5px_5px_white] relative overflow-hidden">
                ...
                <input type="text" name="userId" placeholder="userId" className="p-3 rounded-md border-none outline-none bg-gray-800 text-white" />
